        ...
        <Container>
            ...
            <Row className='wrapper-product ml-1'>
                ...
                <Col xl={4} md={4} sm={4} xs={4} className='text-right p-0 d-flex flex-column justify-content-between'>
                    {props.product.products && <TotalPrice>{totalPrice()}</TotalPrice>}
                    <TotalPrice>Free</TotalPrice>
                    {props.product.products && <TotalPrice>${props.product.taxes}</TotalPrice>}
                </Col>
            </Row>
            <Row className='mt-3'>
                <Col>
                ...
                <Col className='text-right pb-5'>
                    {props.product.products && <TotalPricePurple>${totalPrice() + props.product.taxes}</TotalPricePurple>}
                </Col>
            </Row>
